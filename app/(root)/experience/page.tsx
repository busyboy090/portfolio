            ...
            {(!Array.isArray(education) || education.length === 0) ? (
              ...
              education.map((edu) => (
                <motion.div
                  key={edu.id}
                  variants={fadeInUp}
                  className="p-8 rounded-xl border border-zinc-200/80 dark:border-zinc-800/80 bg-zinc-50/50 dark:bg-zinc-950/40"
                >
            ...
            {(!Array.isArray(certifications) || certifications.length === 0) ? (
              ...
              certifications.map((cert) => (
                <motion.div
                  key={cert.id}
                  variants={fadeInUp}
                  className="p-6 rounded-xl border border-zinc-200/80 dark:border-zinc-800/80 bg-zinc-50/50 dark:bg-zinc-950/40"
                >
