...
export default function AboutPage() {
  return (
    <div className="py-20 px-6 sm:px-12 bg-[#030305]">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 items-start mb-20">
          ...
          >
            <motion.div variants={scaleIn} className="p-6 rounded-xl border border-zinc-800/80 bg-zinc-950/50 flex flex-col justify-between">
            ...
            <motion.div variants={scaleIn} className="p-6 rounded-xl border border-zinc-800/80 bg-zinc-950/50 flex flex-col justify-between col-span-2">
